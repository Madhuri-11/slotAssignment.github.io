...
window.addEventListener('load', function () {
    ...
    app.loader
        .add('symbol_0', 'slotAssignment.github.io/assets/symbols/symbol_00.json')
        .add('symbol_1', 'slotAssignment.github.io/assets/symbols/symbol_01.json')
        .add('symbol_2', 'slotAssignment.github.io/assets/symbols/symbol_02.json')
        .add('symbol_3', 'slotAssignment.github.io/assets/symbols/symbol_03.json')
        .add('symbol_4', 'slotAssignment.github.io/assets/symbols/symbol_04.json')
        .add('symbol_5', 'slotAssignment.github.io/assets/symbols/symbol_05.json')
        .add('reelsBg',  'slotAssignment.github.io/assets/reelsBg.jpg')
